<template>
    ...
    <CModal alignment="center" :visible="visibleModalCerti" size="lg"
        ...
        <CModalBody>
            <CRow class="mb-3">
                <CFormLabel for="inputDate" class="col-sm-4 col-form-label">Aplikasinya dalam kehidupan sehari-hari</CFormLabel>
                <div class="col-sm-8">
    ...
    data() {
        return {
            ...
            columnDefs: [
                ...
                { headerName: 'Aplikasinya dalam kehidupan sehari-hari', field: 'date_schedule', flex: 7, sortable: true, filter: true },
                {
                    headerName: 'Actions',
                    field: 'actions',
                    flex: 2,
