...
export default {
    ...
    methods: {
        async getUsersData(idUser) {
            try {
                const response = await axios.get(`http://localhost:8000/api/xyz/clients/${idUser}`, {
                    headers: {
        ...
        async saveChanges() {
            try {
                ...
                const response = await axios.post('http://localhost:8000/api/xyz/clients/edit', formData, {
                    headers: {
